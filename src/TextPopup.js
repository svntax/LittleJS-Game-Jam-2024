...
class TextPopup extends EngineObject {
    ...
    render(){
        ...
        LittleJS.drawText(this.text, textPos, 0.5, LittleJS.WHITE, 0, LittleJS.WHITE, "center", "PressStart2P");
        LittleJS.drawText(this.text, textPos.add(vec2(-roomWidthInTiles, 0)), 0.5, LittleJS.WHITE, 0, LittleJS.WHITE, "center", "PressStart2P");
        LittleJS.drawText(this.text, textPos.add(vec2(roomWidthInTiles, 0)), 0.5, LittleJS.WHITE, 0, LittleJS.WHITE, "center", "PressStart2P");
    }
